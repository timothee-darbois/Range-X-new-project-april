...
glmm_vegh_tc<- lmer(height_veg_cm~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
#plot confidence
g0_vegh <- ggplot(newdat, aes(x=treat2.y, y=height_veg_cm, colour=temp)) +
...
glmm_reph_tc<-lmer(height_rep_cm~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
#plot confidence
g0_reph <- ggplot(newdat, aes(x=treat2.y, y=height_rep_cm, colour=temp)) +
  geom_path(aes(group = temp, color = temp),linewidth=0.75,position = position_dodge(width = 0.15))+
  geom_pointrange(aes(ymin = plo, ymax = phi),position = position_dodge(width = 0.15), linewidth=0.75, size=1)+
  xlab("Competition")+
...
glmm_nol_tc<- lmer(no_leaves~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
#plot confidence
g0_nol <- ggplot(newdat, aes(x=treat2.y, y=no_leaves, colour=temp)) +
  geom_path(aes(group = temp, color = temp),linewidth=0.75,position = position_dodge(width = 0.15))+
  geom_pointrange(aes(ymin = plo, ymax = phi),position = position_dodge(width = 0.15), linewidth=0.75, size=1)+
  xlab("Competition")+
...
glmm_nof3<- glmer.nb(no_flowers_tt~temp +  (1|blockID.y)+ (1|species), data=all_trait_pca)
...
glmm_nof_tc<- glmer.nb(no_flowers_tt~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
#plot confidence
g0_nof <- ggplot(newdat, aes(x=treat2.y, y=no_flowers_tt, colour=temp)) +
  geom_path(aes(group = temp, color = temp),linewidth=0.75,position = position_dodge(width = 0.15))+
  geom_pointrange(aes(ymin = plo, ymax = phi),position = position_dodge(width = 0.15), linewidth=0.75, size=1)+
  xlab("Competition")+
...
glmm_ll3<- lmer(leaf_length_mm~temp +  (1|blockID.y)+ (1|species), data=all_trait_pca)
...
glmm_ll_tc<- lmer(leaf_length_mm~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
#plot confidence
g0_ll <- ggplot(newdat, aes(x=treat2.y, y=leaf_length_mm, colour=temp)) +
  geom_path(aes(group = temp, color = temp),linewidth=0.75,position = position_dodge(width = 0.15))+
  geom_pointrange(aes(ymin = plo, ymax = phi),position = position_dodge(width = 0.15), linewidth=0.75, size=1)+
  xlab("Competition")+
  ylab("leaf length (mm)")
...
glmm_lt3<- lmer(thickness~temp +  (1|blockID.y)+ (1|species), data=all_trait_pca)
...
glmm_lt_tc<- lmer(thickness~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
#plot confidence
g0_lt <- ggplot(newdat, aes(x=treat2.y, y=thickness, colour=temp)) +
  geom_path(aes(group = temp, color = temp),linewidth=0.75,position = position_dodge(width = 0.15))+
  geom_pointrange(aes(ymin = plo, ymax = phi),position = position_dodge(width = 0.15), linewidth=0.75, size=1)+
  xlab("Competition")+
...
glmm_lw3<- lmer(leaf_width_mm~temp +  (1|blockID.y)+ (1|species), data=all_trait_pca)
...
glmm_lw_tc<- lmer(leaf_width_mm~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
#plot confidence
g0_lw <- ggplot(newdat, aes(x=treat2.y, y=leaf_width_mm, colour=temp)) +
  geom_path(aes(group = temp, color = temp),linewidth=0.75,position = position_dodge(width = 0.15))+
  geom_pointrange(aes(ymin = plo, ymax = phi),position = position_dodge(width = 0.15), linewidth=0.75, size=1)+
  xlab("Competition")+
  ylab("leaf width (mm)")
...
glmm_nrs3<- glmer.nb(no_rep_stems~temp +  (1|blockID.y)+ (1|species), data=all_trait_pca)
...
glmm_nrs_tc<- glmer.nb(no_rep_stems~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
newdat$no_rep_stems <- predict(glmm_nrs_tc,newdat,re.form=NA)
...
#plot confidence
g0_nrs <- ggplot(newdat, aes(x=treat2.y, y=no_rep_stems, colour=temp)) +
  geom_path(aes(group = temp, color = temp),linewidth=0.75,position = position_dodge(width = 0.15))+
  geom_pointrange(aes(ymin = plo, ymax = phi),position = position_dodge(width = 0.15), linewidth=0.75, size=1)+
  xlab("Competition")+
...
glmm_dm3<- lmer(dry_mass~temp +  (1|blockID.y)+ (1|species), data=all_trait_pca)
...
glmm_dm_tc<- lmer(dry_mass~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
#plot confidence
g0_dm <- ggplot(newdat, aes(x=treat2.y, y=dry_mass, colour=temp))+
  geom_path(aes(group = temp, color = temp),linewidth=0.75,position = position_dodge(width = 0.15))+
...
glmm_ldmc3<- lmer(LDMC~temp +  (1|blockID.y)+ (1|species), data=all_trait_pca)
...
glmm_ldmc_tc<- lmer(LDMC~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
#final graph with confidence interval
```{r}
glmm_ldmc_tc<- lmer(LDMC~treat2.y*temp + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
#plot confidence
g0_ldmc <- ggplot(newdat, aes(x=treat2.y, y=LDMC, colour=temp)) +
  geom_path(aes(group = temp, color = temp),linewidth=0.75,position = position_dodge(width = 0.15))+
  geom_pointrange(aes(ymin = plo, ymax = phi),position = position_dodge(width = 0.15), linewidth=0.75, size=1)+
  xlab("Competition")
g0_ldmc
...
```{r}
g0_total1<-ggarrange(g0_ldmc,g0_dm, g0_nrs, g0_lw, ncol=2, nrow=2, common.legend = TRUE, legend="bottom")

g0_total2<-ggarrange(g0_lt, g0_ll, g0_nof, g0_nol,  ncol=2, nrow=2, common.legend = TRUE, legend="bottom")
