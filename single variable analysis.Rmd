...
## interactions
```{r}
glmm_dm_sc<- lmer(LDMC~site*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)

glmm_dm_tc<- lmer(LDMC~temp*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
