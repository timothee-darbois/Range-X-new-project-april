...
g0_vegh2<-ggdraw(add_sub(g0_vegh2,"Competition:*** Site:NS Temperature:**",size=11,y=0.65))
g0_vegh2
...
g0_reph2<-ggdraw(add_sub(g0_reph2,"Competition:*** Site:NS Temperature:**",size=11,y=0.65))
g0_reph2
...
g0_nol2<-ggdraw(add_sub(g0_nol2,"Competition:*** Site:NS Temperature:**",size=11,y=0.65))
g0_nol2
...
g0_nof2<-ggdraw(add_sub(g0_nof2,"Competition:*** Site:NS Temperature:**",size=11,y=0.65))
g0_nof2
...
g0_ll2<-ggdraw(add_sub(g0_ll2,"Competition:*** Site:* Temperature:* ",size=11,y=0.65))
g0_ll2
...
g0_ldmc2<-ggdraw(add_sub(g0_ldmc2,"Competition:*** Site:** Temperature:NS ",size=11,y=0.65))
g0_ldmc2
...
```{r}
pred_sn2<-ggpredict(glmm_sn_tc,terms=c("treat2.y", "temperature"))
...
```{r}
pred_wps2<-ggpredict(glmm_wps_tc,terms=c("treat2.y", "temperature"))
g0_wps2<-plot(pred_wps2) + ggtitle(" ") +
  ...
  xlab("competition") + 
  ylab("log(weight per seed)")

g0_wps2<-ggdraw(add_sub(g0_wps2,"Competition:NS Site:** Temperature:NS ",size=11,y=0.65))
g0_wps2
```
...
```{r}
g0_total2<-ggarrange(g0_lw2, g0_ll2, g0_dm2, g0_vegh2, g0_reph2, legend, ncol=3, nrow=2)
g0_total2
```
