...
```
```{r}
pred_vegh2<-ggpredict(glmm_vegh_tc,terms=c("treat2.y", "temperature"))
g0_vegh2<-plot(pred_vegh2) + ggtitle(" ") +
...
g0_vegh2<-ggdraw(add_sub(g0_vegh2,"Competition:*** Site:* Temperature:**",size=11,y=0.65))
g0_vegh2
...
```
```{r}
pred_reph2<-ggpredict(glmm_reph_tc,terms=c("treat2.y", "temperature"))
g0_reph2<-plot(pred_reph2) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  theme(legend.position="none")+
  xlab("competition") + 
...
g0_reph2<-ggdraw(add_sub(g0_reph2,"Competition:* Site:*** Temperature:**",size=11,y=0.65))
g0_reph2
...
## interactions
```{r}
glmm_nol_sc<- glmer.nb(no_leaves~site*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)

glmm_nol_tc<- glmer.nb(no_leaves~temperature*treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
```{r}
pred_nol2<-ggpredict(glmm_nol_tc,terms=c("treat2.y", "temperature"))
g0_nol2<-plot(pred_nol2) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  xlab("competition") + 
...
g0_nol2<-ggdraw(add_sub(g0_nol2,"Competition:*** Site:*** Temperature:NS",size=11,y=0.65))
g0_nol2
...
```{r}
pred_nof2<-ggpredict(glmm_nof_tc,terms=c("treat2.y", "temperature"))
g0_nof2<-plot(pred_nof2) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  xlab("competition") + 
  ylab("number of inflorescence")+
  theme(legend.position="none")

g0_nof2<-ggdraw(add_sub(g0_nof2,"Competition:*** Site:*** Temperature:NS",size=11,y=0.65))
g0_nof2
...
```{r}
pred_ll2<-ggpredict(glmm_ll_tc,terms=c("treat2.y", "temperature"))
g0_ll2<-plot(pred_ll2) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  theme(legend.position="none")+
  xlab("competition") + 
...
g0_ll2<-ggdraw(add_sub(g0_ll2,"Competition:*** Site:* Temperature:* ",size=25,y=0.65))
g0_ll2
...
```{r}
pred_lt2<-ggpredict(glmm_lt_tc,terms=c("treat2.y", "temperature"))
g0_lt2<-plot(pred_lt2) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  theme(legend.position="none")+
  xlab("competition") + 
...
g0_lt2<-ggdraw(add_sub(g0_lt2,"Competition:*** Site:*** Temperature:NS ",size=11,y=0.65))
g0_lt2
...
```{r}
pred_lw2<-ggpredict(glmm_lw_tc,terms=c("treat2.y", "temperature"))
g0_lw2<-plot(pred_lw2) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  theme(legend.position="none")+
  xlab("competition") + 
...
g0_lw2<-ggdraw(add_sub(g0_lw2,"Competition:** Site: NS Temperature:* ",size=11,y=0.65))
g0_lw2
...
```{r}
pred_nrs2<-ggpredict(glmm_nrs_tc,terms=c("treat2.y", "temperature"))
g0_nrs2<-plot(pred_nrs2) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  xlab("competition") + 
  ylab("number of reproductive stems")+
...
g0_nrs2<-ggdraw(add_sub(g0_nrs2,"Competition:*** Site:*** Temperature:NS ",size=11,y=0.65))
g0_nrs2
...
```{r}
pred_dm2<-ggpredict(glmm_dm_tc,terms=c("treat2.y", "temperature"))
g0_dm2<-plot(pred_dm2) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  theme(legend.position="none")+
  xlab("competition") + 
...
g0_dm2<-ggdraw(add_sub(g0_dm2,"Competition:*** Site:** Temperature:NS ",size=11,y=0.65))
g0_dm2
...
```{r}
pred_ldmc2<-ggpredict(glmm_ldmc_tc,terms=c("treat2.y", "temperature"))
g0_ldmc2<-plot(pred_ldmc2) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  theme(legend.position="none")+
  xlab("competition") + 
...
g0_ldmc2<-ggdraw(add_sub(g0_ldmc2,"Competition:*** Site:** Temperature:NS ",size=25,y=0.65))
g0_ldmc2
...
glmm_wps3<- lmer(weight.seed.log2~temperature + (1|blockID.y)+ (1|species), data=all_trait_pca)

glmm_wps4<- lmer(weight.seed.log2~treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)
...
glmm_wps3<- lmer(log(weight.seed.log)~temperature + (1|blockID)+ (1|species), data=df)

glmm_wps4<- lmer(log(weight.seed.log)~treat2 + (1|blockID)+ (1|species), data=df)
glmm_wps_tc<- lmer(log(weight.seed.log)~temperature*treat2 + (1|blockID)+ (1|species), data=df)
```
...
glmm_sn_tc<- glmer.nb(seeds_number.inf~temperature*treat2.y + (1|blockID.y)+ (1|species), data=all_trait)


glmm_sn3<- glmer.nb(seeds_number.inf~temperature + (1|blockID.y)+ (1|species), data=all_trait)
glmm_sn4<- glmer.nb(seeds_number.inf~treat2.y + (1|blockID.y)+ (1|species), data=all_trait_pca)


```{r}
glmm_sn1<- glmer.nb(seeds_number.inf~condi + (1|blockID)+ (1|species), data=df_percentage)
...
combined <- g0_nof2+g0_nol2 & theme(legend.position = "bottom")
combined + plot_layout(guides = "collect")



```{r}
pred_sn2<-ggpredict(glmm_sn_tc,terms=c("treat2", "temp"))
g0_sn2<-plot(pred_sn2,show.legend=FALSE) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  theme(legend.position="none")+
  xlab("competition") + 
...
g0_sn2<-ggdraw(add_sub(g0_sn2,"Competition:NS Site:NS Temperature:NS ",size=11,y=0.65))
g0_sn2

```
#glmm weight per seed
```{r}
glmm_wps1<- lmer(log(weight.seed.log)~condi + (1|blockID)+ (1|species), data=df)
...
```{r}
pred_wps2<-ggpredict(glmm_wps_tc,terms=c("treat2", "temperature"))
g0_wps2<-plot(pred_wps2) + ggtitle(" ") +
  geom_line(position = position_dodge(width = 0.25)) +
  geom_pointrange(aes(ymin = conf.low, ymax = conf.high), position = position_dodge(width = 0.25), linewidth = 0.75, size = 1) +
  theme(legend.position="none")+
  theme(text = element_text(size = 25))+
  ...
  xlab("competition") + 
  ylab("weight per seed")

g0_wps2<-ggdraw(add_sub(g0_wps2,"Competition:NS Site:*** Temperature:NS ",size=25,y=0.65))
g0_wps2
```
...
```{r}
legend<-plot(pred_wps2,dot.size=0,line.size=0,connect.lines=FALSE,ci=FALSE) + ggtitle(" ") +
  geom_point(size=0)+
  theme_void()+
...
```{r}
g0_total1<-ggarrange(g0_nof2,g0_nol2, g0_nrs2, g0_ldmc2, g0_lt2,legend, ncol=3, nrow=2)
g0_total1
```
...
```{r}
g0_total2<-ggarrange(g0_nof2,g0_nol2, g0_nrs2, g0_ldmc2, g0_lt2,g0_lw2, g0_ll2, g0_dm2, g0_vegh2, g0_reph2, legend, ncol=4, nrow=3)
g0_total2
```

# need the germination experiment file to be loaded and run to work
```{r}
g0_total3<-ggarrange(g0_gp2, g0_sn2, g0_wps2, legend, ncol=2, nrow=2)
g0_total3
```

## calculate the effect of each variables
```{r}
vectorOfTables <- vector(mode = "list", length = 2)
vectorOfTables[[1]] <- pred_dm2
vectorOfTables[[2]] <- pred_ldmc2
vectorOfTables[[3]] <- pred_ll2
vectorOfTables[[4]] <- pred_lt2
vectorOfTables[[5]] <- pred_lw2
vectorOfTables[[6]] <- pred_nof2
vectorOfTables[[7]] <- pred_nol2
vectorOfTables[[8]] <- pred_nrs2
vectorOfTables[[9]] <- pred_reph2
vectorOfTables[[10]] <- pred_sn2
vectorOfTables[[11]] <- pred_vegh2
vectorOfTables[[12]] <- pred_wps2
vectorOfTables[[13]] <-pred_gp2

traits=c("dm","ldmc","ll","lt","lw","nof","nol","nrs","reph","sn","vegh","wps","gp")
```

```{r}
temp=c("ambient","ambient","warm","ambient","ambient","warm")
site=c("HS","LS","HS","HS","LS","HS")

results=vectorOfTables
for (i in 1:13){
  results[[i]]<-data.frame(condi=paste(vectorOfTables[[i]]$group,vectorOfTables[[i]]$x),trait_value=vectorOfTables[[i]]$predicted,temperature=temp,site=site,competition=vectorOfTables[[i]]$x)
}
```

```{r}
effect_variables=data.frame(traits=traits,competition=rep(0,13),site=rep(0,13),temperature=rep(0,13))
for (i in 1:13){
  #competition
  bare<-mean(results[[i]][which(results[[i]]$competition=="bare"),]$trait_value)
  vegetated<-mean(results[[i]][which(results[[i]]$competition=="vege"),]$trait_value)
  effect_variables[i,"competition"]<-vegetated/bare
  
   #site
  HS<-mean(results[[i]][which(results[[i]]$site=="HS"),]$trait_value)
  LS<-mean(results[[i]][which(results[[i]]$site=="LS"),]$trait_value)
  effect_variables[i,"site"]<-HS/LS
  
   #temperature
  ambient<-mean(results[[i]][which(results[[i]]$temperature=="ambient"&site=="HS"),]$trait_value)
  warm<-mean(results[[i]][which(results[[i]]$temperature=="warm"),]$trait_value)
  effect_variables[i,"temperature"]<-warm/ambient
...
```{r}
#wps:
wps_value<-data.frame(condi=paste(vectorOfTables[[12]]$group,vectorOfTables[[12]]$x),weighperseed= exp(vectorOfTables[[12]]$predicted),temperature=temp,site=site,competition=vectorOfTables[[12]]$x)
wps_effect<-c()

  HS<-mean(wps_value[which(wps_value$site=="HS"),]$weighperseed)
  LS<-mean(wps_value[which(wps_value$site=="LS"),]$weighperseed)
  wps_effect<-HS/LS
1/wps_effect
```
calculating inverse ( to only have value above 1)
```{r}
effect_inverse<-data.frame(traits=traits,competition=1/effect_variables$competition,site=1/effect_variables$site,temperature=1/effect_variables$temperature)
effect_inverse
```
# ratio effect of competition effect of site
```{r}
traits_site=c("ll","dm","nrs","ldmc","lt","gp","wps")
traits_temp=c("lw","ll","vegh","reph","nof","nol")

change_intensity_comp=c(rep(0,13))
change_intensity_site=c(rep(0,13))
change_intensity_temp=c(rep(0,13))

for (i in 1:13){
  change_intensity_comp[i]<-max(effect_variables$competition[i],1/effect_variables$competition[i])
  change_intensity_site[i]<-max(effect_variables$site[i],1/effect_variables$site[i])
  change_intensity_temp[i]<-max(effect_variables$temperature[i],1/effect_variables$temperature[i])
}
change_intensity=data.frame(traits=traits,comp_site=change_intensity_comp/change_intensity_site,comp_temp=change_intensity_comp/change_intensity_temp,site_temp=change_intensity_site/change_intensity_temp)
...
change_intensity_site_significant<-change_intensity[which(traits %in% traits_site),]
mean(change_intensity_site_significant$comp_site)

change_intensity_temp_significant<-change_intensity[which(traits %in% traits_temp),]
mean(change_intensity_temp_significant$comp_temp)
#t.test(change_intensity_temp,change_intensity_comp)

```


```{r}
a<-data.frame(condi=paste(pred_nol2$group,pred_nol2$x),trait_value=pred_nol2$predicted)
```
