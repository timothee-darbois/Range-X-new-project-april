...
### interact plot: à poursuivre
```{r}
glmm_vegh_reph_c<-lmer(height_veg_cm~log(weight.seed.log)*competition+(1|species)+(1|blockID.y),data=all_trait_pca)
glmm_vegh_reph_t<-lmer(height_veg_cm~log(weight.seed.log)*temperature+(1|species)+(1|block),data=all_trait_pca)
g_vegh_reph_c<- interact_plot(glmm_vegh_reph_c,pred=weight.seed.log,modx=competition,interval =TRUE, int.type="confidence")+ xlab("seed weight")
g_vegh_reph_t<- interact_plot(glmm_vegh_reph_t,pred=weight.seed.log,modx=temperature,interval =TRUE, int.type="confidence")+ xlab("seed weight")
ggarrange(g_vegh_reph_c, g_vegh_reph_t, ncol=1, nrow=2)
summary(glmm_vegh_reph_c)
summary(glmm_vegh_reph_t)
```
...
### interact plot: à poursuivre
```{r}
glmm_wps_nof_c<-lmer(no_flowers_tt~log(weight.seed.log)*competition+(1|species)+(1|blockID.y),data=all_trait_pca)
glmm_wps_nof_t<-lmer(no_flowers_tt~log(weight.seed.log)*temperature+(1|species)+(1|block),data=all_trait_pca)
g_wps_nof_c<- interact_plot(glmm_wps_nof_c,pred=weight.seed.log,modx=competition,interval =TRUE, int.type="confidence")+ xlab("seed weight")
g_wps_nof_t<- interact_plot(glmm_wps_nof_t,pred=weight.seed.log,modx=temperature,interval =TRUE, int.type="confidence")+ xlab("seed weight")
...
### interact plot: à poursuivre
```{r}
glmm_wps_nol_c<-lmer(no_leaves~log(weight.seed.log)*competition+(1|species)+(1|blockID.y),data=all_trait_pca)
glmm_wps_nol_t<-lmer(no_leaves~log(weight.seed.log)*temperature+(1|species)+(1|block),data=all_trait_pca)
g_wps_nol_c<- interact_plot(glmm_wps_nol_c,pred=weight.seed.log,modx=competition,interval =TRUE, int.type="confidence")+ xlab("seed weight")
g_wps_nol_t<- interact_plot(glmm_wps_nol_t,pred=weight.seed.log,modx=temperature,interval =TRUE, int.type="confidence")+ xlab("seed weight")
...
### interact plot: à poursuivre
```{r}
glmm_wps_ll_c<-lmer(leaf_length_mm~log(weight.seed.log)*competition+(1|species)+(1|blockID.y),data=all_trait_pca)
glmm_wps_ll_t<-lmer(leaf_length_mm~log(weight.seed.log)*temperature+(1|species)+(1|block),data=all_trait_pca)
g_wps_ll_c<- interact_plot(glmm_wps_ll_c,pred=weight.seed.log,modx=competition,interval =TRUE, int.type="confidence")+ xlab("seed weight") + ylab("leaf length(mm)")
g_wps_ll_t<- interact_plot(glmm_wps_ll_t,pred=weight.seed.log,modx=temperature,interval =TRUE, int.type="confidence")+ xlab("seed weight")+ ylab("leaf length(mm)")
