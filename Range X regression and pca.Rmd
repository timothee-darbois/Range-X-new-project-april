...
```{r}
#$completeObs
column_pca<- c("wet_mass","dry_mass" ,"thickness", "veg_height",  "height_rep_strech_cm" , "repr_height" ,"height_veg_stretch_cm" ,"leaf_length","leaf_width_mm" ,"nb_leaves","nb_rep_stems","seeds_number.inf", "weight.inf"   ,"weight.seed", "no_flowers_tt", "germination_percentage", "germinated+viable"  )  
